...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://postgres:soo930@localhost:5432/nomadgram")
}
...
LOCAL_APPS = [
    ...
    "nomadgram.notifications.apps.NotificationsConfig", # notifications 앱
]
...
ADMINS = [("""kwon soo yeon""", "kwon-soo-yeon@example.com")]
